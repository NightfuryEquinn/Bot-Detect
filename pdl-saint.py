...
# coding: utf-8
# =============================================================================
# pdl-saint.py — SAINT: Self-Attention + Intersample Attention Transformer
# =============================================================================
...
SAVE_DIR = "result/saint"
os.makedirs(SAVE_DIR, exist_ok=True)
os.makedirs("result/logs/saint", exist_ok=True)
...
ax.set_ylabel("Count")
plt.tight_layout()
save_fig(fig, SAVE_DIR, "00_class_balance")
...
class SAINT(nn.Module):
    ...
    def forward(self, x, use_intersample=True):
        B      = x.shape[0]
        tokens = self.input_norm(self.tokenizer(x))
...
plt.tight_layout()
save_fig(fig, SAVE_DIR, "01_oof_roc_pr")
...
plt.tight_layout()
save_fig(fig, SAVE_DIR, "02_confusion_matrix")
...
plt.tight_layout()
save_fig(fig, SAVE_DIR, "03_shap_importance")
...
plt.savefig(f"{SAVE_DIR}/03c_shap_dependence_{top_feat}.png",
            bbox_inches="tight", facecolor="#0F1117")
plt.close()
print(f"  ↳ Saved  {SAVE_DIR}/03c_shap_dependence_{top_feat}.png")
...
plt.tight_layout()
save_fig(fig, SAVE_DIR, "04_score_distribution")
...
submission_path = f"{SAVE_DIR}/saint_submission.csv"
